...
export default function Welcome() {
    ...
    return (
        <div className="text-gray-700 dark:text-gray-300 container mx-auto p-8 overflow-hidden md:rounded-lg md:p-10 lg:p-12">
            ...
            <div className="text-center h-12 md:overflow-hidden" tabIndex={0}>
                <p className="text-center text-wrap mb-3 md:mb-0 font-sans text-3xl md:text-4xl font-bold text-gray-500 dark:text-gray-200">
                    <Typewriter
